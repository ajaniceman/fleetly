...
import { BrowserRouter as Router, Routes, Route, Navigate, useLocation } from 'react-router-dom'; // Added BrowserRouter as Router
...
function App() {
  ...
  return (
    // Wrap the entire application with ThemeProvider and Router
    <Router> {/* Router must wrap Routes */}
